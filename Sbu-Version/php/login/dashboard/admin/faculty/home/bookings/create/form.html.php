            ...
            <form action="">
                ...
                <div class="dash_body">
                   ...
                   <div style="margin-left: 29.1em;" class="text">
                    <input type="text" name="Add Courses">
                </div>
                ...
                <div class="description">
                    ...
                    <div style="margin-left: 27em;" class="text">
                    <textarea maxlength="250" wrap="hard" name="examDescription" id="discription" cols="30" rows="5"></textarea>
                </div>
                </div>
                ...
                <div class="dash_body">
                   ...
                   <div style="margin-left: 28em;" class="text">
                    <select name="venues">
                            ...
                            <?php
                            //Getting venue names from database 
                ...
                <div class="dash_body">
                   ...
                   <div style="margin-left: 31.4em;" class="text">
                    <select name="venues">
                        <option  value="" >Select Venue</option>
                        <?php
                            //Getting venue names from database 
